...
func SendMail() {
	...
	m.SetHeader("From", "emaill@drmonkey.co") // Usa un email verificado en Mandrill
	...
	d := gomail.NewDialer("smtp.mandrillapp.com", 587, "emaill@drmonkey.co", "md-AvpMklQ9xGOqLz1Etast_Q")
	// Enviar el correo
